...
#############################################################################
{
    'name': 'Odoo17 Commission Payroll Accounting',
    'version': '17.0.1.0.0',
    ...
    'author': 'Nic Leeehard',
    'company': 'Nic Leeehard',
    'maintainer': 'Nic Leeehard',
    'website': "https://www.openhrms.com",
    'depends': ['hr_payroll_commission', 'account'],
    'data': [ 'views/hr_commission_payslip_views.xml'],
