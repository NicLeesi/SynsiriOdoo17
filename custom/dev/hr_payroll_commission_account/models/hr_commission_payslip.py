...
class PayrollCommission(models.Model):
    ...
    def create(self, vals):
        ...
        return super(PayrollCommission, self).create(vals)
    ...
    def onchange_contract_id(self):
        ...
        super(PayrollCommission, self).onchange_contract_id()
    ...
    def action_com_payslip_cancel(self):
        ...
        moves.unlink()
        return super(PayrollCommission, self).action_com_payslip_cancel()
    ...
    def action_com_payslip_done(self):
        ...
        res = super(PayrollCommission, self).action_com_payslip_done()
        for slip in self:
            line_ids = []
            debit_sum = 0.0
            credit_sum = 0.0
            name = _('Comslip of %s') % slip.employee_id.name
            move_dict = {
                'narration': name,
                'ref': slip.number,
            ...
            if not move.line_ids:
                raise UserError(
                    _("As you installed the commission payroll accounting module you have"
